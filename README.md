...
- [PayCrow](https://github.com/michu5696/paycrow) - Escrow protection with dispute resolution for AI agent payments on Base. 9 MCP tools including trust-informed smart escrow (safe_pay) and on-chain trust scoring. The only escrow on Base with real dispute resolution. $0.001 USDC per trust query via x402. ([npm](https://www.npmjs.com/package/paycrow)) | [Live API](https://paycrow-app.fly.dev)
...
- [PayCrow](https://github.com/michu5696/paycrow) - Escrow protection with on-chain dispute resolution for AI agent payments on Base. 9 MCP tools including trust-informed smart escrow (safe_pay), trust scoring from 5 on-chain data sources, and the only escrow contract on Base with real dispute resolution. $0.001 USDC per trust query via x402. ([npm](https://www.npmjs.com/package/paycrow)) | [Live API](https://paycrow-app.fly.dev)
