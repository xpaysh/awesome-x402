...
- [VulnFeed MCP](https://vulnfeed.novadyne.ai) - Dependency vulnerability scanner with EPSS scoring for AI agents. 9 MCP tools, x402 micropayments on Base mainnet. Free tier (10 scans/day). `pip install vulnfeed-mcp`. ([GitHub](https://github.com/novadyne-hq/vulnfeed-mcp)) ([PyPI](https://pypi.org/project/vulnfeed-mcp/))
- [Ledger API](https://ledger-api.novadyne.ai) - Double-entry accounting API with Ed25519 capability tokens and x402 micropayments. $0.01/write, $0.002/read USDC on Base.
