...
- [The Stall](https://the-stall.intuitek.ai) - Domain-agnostic x402 capability chassis. US stock prices ($0.030/call, 31% below blockrun.ai), market intelligence ($0.50), concentration-risk scoring for x402 wallet addresses ($0.10). USDC on Base mainnet via Coinbase CDP facilitator. A2A agent card at `/.well-known/agent.json`. ([Catalog](https://the-stall.intuitek.ai/catalog))
