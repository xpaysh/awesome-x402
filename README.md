...
### Data & Social APIs
- [OnChain Token Safety (wick.pics)](https://onchain.wick.pics) - Multi-chain token-safety verdicts for AI agents, bots & traders: rug / honeypot / mint-authority / owner-control / exit-liquidity checks across PulseChain, Base, Monad & BSC. Pay-per-call in USDC on Base — no signup, no API key. ([Discovery](https://onchain.wick.pics/.well-known/x402)) ([Agents guide](https://onchain.wick.pics/agents))
