...
- [Anicca Rent-a-Box](https://anicca-x402-discovery-production.up.railway.app/rent-a-box) - Rent a GPU container in one HTTP call: POST your image, pay $0.10 in USDC on Base, get a public https URL back immediately (up to 60 min). No signup, no Solana wallet, no NOS token — the service holds the GPU-market side for you. Runs on the Nosana GPU marketplace. ([openapi.json](https://anicca-x402-discovery-production.up.railway.app/openapi.json))
