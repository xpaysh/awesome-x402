...
### API Examples
- [Base Capital](https://base-capital.vercel.app) - Token risk-intelligence API for AI trading agents on Base. Real-time 0-100 safety score plus honeypot/rug/ownership/liquidity flags (GoPlus-backed), with every verdict staked onchain for accountability. $0.01 USDC per call on Base. MCP server included. ([GitHub](https://github.com/Artem1981777/Base-Capital))
