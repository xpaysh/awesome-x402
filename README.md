...
- [Micro Data API Factory — Biz Calendar](https://biz-calendar-data-api.kasanegi123.workers.dev) - Japan business calendar for AI agents. v1: is-business-day, next-business-day, holidays, gotobi across bank / admin / sse axes (Cabinet Office public-domain embed, 2024-2027). **v2 (2026-04): quarter-ends, fiscal-year-end, ex-dividend-date, shareholder-meeting-window, settlement-date** — JPX T+1 rule (effective 2024-11-05) + Companies Act Art.296+124 shareholder-meeting window + 3月決算 conventions. All 9 endpoints $0.001 USDC per call on Base; zero upstream fetch (pure static derivation). [.well-known/x402](https://biz-calendar-data-api.kasanegi123.workers.dev/.well-known/x402) | [/supported](https://biz-calendar-data-api.kasanegi123.workers.dev/supported) | [llms.txt](https://biz-calendar-data-api.kasanegi123.workers.dev/llms.txt) | [MCP gateway](https://mcp-data-gateway.kasanegi123.workers.dev/mcp)
