...
- [Crest Deployment Systems](https://crestsystems.ai) - 3 x402 services on Base mainnet. **supership**: predeploy security scanner, 80+ vulnerability patterns, free trust check for any x402 service URL, witnessed attestation $0.01. **data**: crypto market data, token lookups, gas prices, trending, DeFi TVL at $0.01/call. **audit**: smart contract audit $1, code security scan $0.50, wallet risk profiling $0.25. All services include agent.json, llms.txt, OpenAPI discovery. ([supership](https://supership.crestsystems.ai) | [data](https://data.crestsystems.ai) | [audit](https://audit.crestsystems.ai) | [npm](https://www.npmjs.com/package/supership-scan) | [GitHub](https://github.com/andysalvo/supership-scan))
