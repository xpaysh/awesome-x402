...
- [AgentBodega](https://agentbodega.store) - Agent-ready paid API catalog with 65 x402-payable HTTP JSON resources for search, web fetch, public data, social media, status checks, media conversion, and agent-readiness audits. No API keys; includes [x402 discovery](https://agentbodega.store/.well-known/x402), [OpenAPI](https://agentbodega.store/openapi.json), and MCP.
