...
- [Qonoro Intelligence API](https://api.qonoro.ai/docs) — x402-native B2B intelligence APIs for autonomous AI agents on Base mainnet. 16 agents, 21 endpoints: company research, enrichment, and search; competitor analysis; sales and buying-intent signals; lead qualification; person enrichment and search; job-change detection; hiring signals; KYB entity verification; domain intelligence and resolution; news sentiment; outbound personalization; plus email, phone, URL, and address validation/normalization and NAICS classification. Structured JSON outputs with source-backed evidence and confidence scores. Pay-per-call in USDC, no subscription, no API key. Machine-readable pricing per endpoint at `/v1/pricing/{agent_id}`. ([Docs](https://api.qonoro.ai/docs) | [MCP](https://pypi.org/project/qonoro-mcp/) | [Health](https://api.qonoro.ai/health) | [Pricing](https://api.qonoro.ai/v1/pricing))
