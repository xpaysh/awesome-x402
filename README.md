...
- [relay402](https://relay402.georgespring.workers.dev) - Pay-per-call verification and data APIs for AI agents on Base: package vulnerability checks (OSV), npm package risk signals, OFAC sanctions screening, robots.txt crawl permission, Wayback snapshots, Amazon product data, barcode product lookup, Greenhouse job openings, and public holidays. $0.005-$0.10 USDC per call via x402 v2, no API keys, no signup. Free demo on every endpoint (?demo=true, no wallet needed). ([Catalog](https://relay402.georgespring.workers.dev/index.json) | [OpenAPI](https://relay402.georgespring.workers.dev/openapi.json) | [llms.txt](https://relay402.georgespring.workers.dev/llms.txt) | [Discovery](https://relay402.georgespring.workers.dev/.well-known/x402.json))
