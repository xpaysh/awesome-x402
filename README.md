...
- [Agent Payment Receipt & Mandate Verifier](https://x402.167-172-95-184.nip.io) - Agent-commerce trust API for x402 builders and wallet-equipped agents. 10 paid routes on Base mainnet: price smoke tests ($0.01-$0.02), portfolio snapshot ($0.05), opportunity feed ($0.03), x402 launch audit ($1.00), receipt verifier ($0.05), mandate verifier ($0.25), MCP tool call ($0.05), morning briefing ($0.03), and research briefs ($0.05). Coinbase CDP facilitator, x402scan verification currently registers 10 routes with 0 failures and 0 warnings. No external revenue is claimed from proof/self-pay traffic. [Discovery](https://x402.167-172-95-184.nip.io/.well-known/x402) | [OpenAPI](https://x402.167-172-95-184.nip.io/openapi.json) | [Manifest](https://x402.167-172-95-184.nip.io/x402.json) | [llms.txt](https://x402.167-172-95-184.nip.io/llms.txt)
