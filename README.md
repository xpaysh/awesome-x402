...
- [GenTech Labs](https://gentechlabs.net) — Agent economy infrastructure: ERC-8004 identity, x402-monetized APIs (DeFi intelligence, security scoring, agent search, fleet monitoring). 45+ paid endpoints on Base via Cloudflare Workers. ([GitHub](https://github.com/ProtoJay4789/gentech-vault))
