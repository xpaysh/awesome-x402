...
- [Viridis Agent Fleet](https://mcp.viridisconservation.com/quickstart) - Five deterministic carbon and compliance APIs for AI agents, payable per call with x402 v2 USDC on Base. Publishes MCP endpoints, Bazaar discovery, an A2A agent card, and a ceiling-protected buyer client; its settled Regulatory Radar fixture is independently reproduced in [x402-endpoint-validator](https://github.com/smartflowproai-lang/x402-endpoint-validator/pull/12). ([x402 Catalog](https://mcp.viridisconservation.com/x402/catalog) | [Bazaar](https://api.cdp.coinbase.com/platform/v2/x402/discovery/merchant?payTo=0xfEf2e570b645EB720Ee6c589d27450810982f329) | [Agent Card](https://mcp.viridisconservation.com/.well-known/agent-card.json) | [Source](https://github.com/jdhart81/viridis-agent-fleet))
