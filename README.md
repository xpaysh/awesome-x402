...
- [wellnizz](https://github.com/liveforeverbetter/wellnizz) - Agent-first API for genetics, biomarkers, and wearables with x402 micropayments. 168+ biomarkers, wearable data (WHOOP, Oura, Garmin), WGS genomics. 21 MCP tools. Pay-per-call via x402 USDC on Base + Stripe subscriptions. Self-hostable (Docker). AGPL-3.0.
