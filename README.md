...
- [VulnFeed MCP](https://vulnfeed.novadyne.ai) - Dependency vulnerability scanner with EPSS scoring for AI agents. 9 MCP tools, x402 micropayments on Base mainnet. Free tier (10 scans/day). `pip install vulnfeed-mcp`. ([GitHub](https://github.com/infai-tech/vulnfeed-mcp)) ([PyPI](https://pypi.org/project/vulnfeed-mcp/))
