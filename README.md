...
### Data & Social APIs
- [Satoshi Lightning Utility API](https://dispatches.mystere.me/docs) — 14 pay-per-call endpoints for Bitcoin & Lightning Network data: mempool fees, BOLT11 invoice decoding, Lightning route queries, **node health scoring, graph search, channel analytics, node lookup**, node stats, AI Q&A. Dual protocol: x402 (USDC on Base) + L402 (Lightning sats). $0.001-$0.005/call. ([Discovery](https://dispatches.mystere.me/.well-known/x402)) ([Docs](https://dispatches.mystere.me/docs))
