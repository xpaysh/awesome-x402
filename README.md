...
- [The Stall](https://the-stall.intuitek.ai) — **189 pay-per-call AI capabilities** via MCP + x402: US equities, crypto, DeFi (DeFiLlama), options chains, Solana, macro, compliance. $0.001–$0.024 USDC on Base. No API keys, no signup. Official MCP registry: `the-stall.intuitek.ai`. ([GitHub](https://github.com/thebrierfox/the-stall) | [MCP](https://the-stall.intuitek.ai/mcp) | [Discovery](https://the-stall.intuitek.ai/.well-known/x402))
...
- [Yield Intelligence MCP](https://api.intuitek.ai/yield/mcp) - Passive income portfolio analysis for AI agents: US Treasuries, dividend ETFs (SCHD, JEPI), REITs, and preferred stocks. Ranked risk-adjusted allocations targeting a monthly income goal. $1 USDC on Base. ([GitHub](https://github.com/thebrierfox/intuitek-ace))
