...
- - [NegPrice Decision Intelligence](https://energy.netzhandwerker.de) - x402-paid ML API for EPEX DE/LU negative electricity price prediction. Provides calibrated 2h/4h/6h probabilities, target prices, risk flags and execution policy for battery storage, EV charging and energy trading agents. Base Mainnet USDC, x402 v2, xpay facilitator. [x402](https://energy.netzhandwerker.de/.well-known/x402) | [Examples](https://energy.netzhandwerker.de/examples/)
