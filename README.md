...
- [Hermes Asia Intelligence](https://base-worker-01.j23726919.workers.dev) - 8-endpoint AI research API: China real estate, Japan tech, geopolitics, market intelligence. $0.02-$0.03 USDC on Base. ([OpenAPI](https://base-worker-01.j23726919.workers.dev/openapi.json))
