...
- [DDG Agent-Payable Services](https://agents.daedalusdevelopmentgroup.com) - AI-agent-native x402/direct-crypto services: checkout conformance audits, MCP/tool security preflight, agent-discovery repair, buyer-agent smoke probes, and paid model routing. Identity-first gating (403 before work, 402 for payment), bounded authority + spend caps, instant revocation, and verifiable receipts with idempotency. 5-chain x402 USDC (Base, Polygon, Arbitrum, World Chain, Solana). MCP server: `pip install ddg-agent-services-mcp`. ([Discovery](https://agents.daedalusdevelopmentgroup.com/.well-known/ai)) ([OpenAPI](https://agents.daedalusdevelopmentgroup.com/openapi.json)) ([llms.txt](https://agents.daedalusdevelopmentgroup.com/llms.txt)) ([x402scan](https://www.x402scan.com/server/c3540307-0eb2-455d-90b6-a21f7d5a3792)) ([GitHub](https://github.com/daedalusdevelopmentgroup/ddg-agent-payable-services))
