...
- [vector402](https://vector402.b-cdn.net) - Machine-payable radio-frequency positioning and node-registration API. Endpoints: position/query, nodes, nodes/{id}/status, nodes/register. Live discovery manifest at [.well-known/x402](https://vector402.b-cdn.net/.well-known/x402). Multi-chain: Solana (USDC), Base (USDC), Algorand (USDCa) via GoPlausible facilitator. $0.001–$0.10 USDC per call. ([Discovery](https://vector402.b-cdn.net/.well-known/x402))
