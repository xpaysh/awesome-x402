...
|- [GenTech Agent Kit](https://github.com/ProtoJay4789/genTech-agent-kit) — MCP server with 15+ tools for AI agents: real-time market data (quotes, listings, search, trending, DEX pairs), DeFi intelligence, x402 payment rails across 3 chains (Algorand, Robinhood Chain, Base), and tokenized stock data (AAPL, NVDA, TSLA). Plugin system with auto-discovery. Install: `uvx --from git+https://github.com/ProtoJay4789/genTech-agent-kit.git gentech-kit`. Skills: `npx skills add ProtoJay4789/genTech-agent-kit`. MIT. ([Docs](https://github.com/ProtoJay4789/genTech-agent-kit)) | ([Skills](https://github.com/ProtoJay4789/genTech-agent-kit/tree/main/skills))
...
|- [GenTech Labs](https://gentechlabs.net) — Agent economy infrastructure: ERC-8004 identity, x402-monetized APIs (market data, DeFi intelligence, security scoring, agent search). 45+ paid endpoints. MCP server with auto-discovered plugins. ([GitHub](https://github.com/ProtoJay4789/genTech-agent-kit)) | ([Skills](https://github.com/ProtoJay4789/genTech-agent-kit/tree/main/skills)) | ([Install](https://github.com/ProtoJay4789/genTech-agent-kit))
