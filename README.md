...
- [Prediction Market Analyst](https://prediction-market-analyst.vercel.app) — AI prediction market intelligence API with 4 x402 endpoints: probability estimation ($0.05), Kelly position sizing ($0.08), market scanning ($0.10), and multi-signal ensemble ($0.15). Calibrated on 994 resolved markets. USDC on Base. MCP server: `node ~/prediction-market-mcp/dist/index.js`.
- [Hardware Product Manager](https://hardware-pm-analyst.vercel.app) — AI hardware product management analyst with 3 x402 endpoints: competitive analysis ($0.02), deep category analysis ($0.08), and PRD generation ($0.12). 20 years of domain expertise in gaming peripherals, consumer audio, and mobile/tablets. USDC on Base. MCP server: `node ~/hardware-pm-mcp/dist/index.js`.
