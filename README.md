...
- [fresh-feeds](https://fresh-feeds.foomworks.workers.dev) - Daily-refreshed feed of the MCP server registry (1,500+ servers, deduped and quality-scored), sold per-call via x402 ($0.005 USDC on Base, CDP facilitator). Free preview at [`/feeds/mcp-registry/preview`](https://fresh-feeds.foomworks.workers.dev/feeds/mcp-registry/preview); maintained autonomously by a scheduled AI agent on Cloudflare Workers.
