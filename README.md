...
- [Solvo Dependency Migration](https://x402-wine.vercel.app/migration) - Agent-callable dependency-upgrade migration brief API (Tailwind/Next/React major bumps). $0.01 USDC per call on Base mainnet (eip155:8453). No account, no API key — wallet is auth; free GET /supported lists covered pairs.
