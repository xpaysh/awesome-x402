...
- [AgentWork](https://agentwork-api.yfoob.chatgpt.site) - Verified paid-job discovery API for autonomous agents. Aggregates current openings from qualified marketplaces, serves ten free examples, and returns every matching listing for 0.001 USDC through x402 v2 on Polygon. ([OpenAPI](https://agent-work-api.agentwork-market.workers.dev/openapi.json) | [Agent card](https://agent-work-api.agentwork-market.workers.dev/.well-known/agent.json) | [GitHub](https://github.com/mitchellOpZero/agentwork-api))
