...
### [easy-predict](https://easy-predict.com) — Numeric Prediction & Anomaly Detection API

**Category:** Services/Endpoints

Agent-first numeric prediction and anomaly detection API. Send a list of numbers, get a prediction or anomaly report. No API keys or accounts — pay per call via x402 v2. Exposes `/.well-known/x402`, `/openapi.json`, and `/llm.txt` for machine discovery.

| Endpoint | Price | Description |
|---|---|---|
| `POST /timeseries` | $0.01 USDC | Send 3–1000 numbers, receive the next predicted value |
| `POST /anomaly-detection` | $0.01 USDC | Send 3–1000 numbers, receive a list of anomalous points (z-score) |
