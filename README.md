...
- [klymax402](https://klymax402.com) - 100 x402-native APIs spanning email/SEO/web scraping/wallet/DEX/Hyperliquid/NFT/ENS. Pure USDC micropayments on Base L2, no signup. Public catalog at [/llms.txt](https://klymax402.com/llms.txt); every endpoint also exposes `/mcp` for MCP SSE clients. ([npm SDK](https://www.npmjs.com/package/x402-agent-tools))
