...
- [Stelar Digital x402 API](https://api.stelardigital.com) - Pay-per-call market data, verification, and extraction endpoints for AI agents. 13 endpoints, USDC on Base. $0.005–$0.05 USDC per call. ([Discovery](https://api.stelardigital.com/.well-known/x402)) ([Catalog](https://api.stelardigital.com/catalog))
