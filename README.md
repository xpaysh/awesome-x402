...
### Tools & Services
- [NEXUS Intelligence API](https://nexus-agent-xa12.onrender.com) - 54-endpoint utility hub via x402: web scraping, DNS, WHOIS, CVE lookup, npm/PyPI risk, AI translation, summarization, PII detection, domain health audit, geocoding, company intel. $0.01-0.10/call on Base. [MCP](https://nexus-agent.mcp.xpay.sh/mcp) | [OpenAPI](https://nexus-agent-xa12.onrender.com/openapi.json)
