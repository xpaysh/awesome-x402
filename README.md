...
- [IDLE Protocol](https://idleprotocol.com) - Distributed residential compute network on Solana. 14 x402 endpoints: web scraping, HTTP fetch, HTML scrape, DNS lookup, SSL check, price extraction, availability check, content verification, change detection and more. AI agents pay $0.01-$0.08/request in USDC. Non-custodial. 85% to node operators. Gateway: [idle-gateway-production.up.railway.app](https://idle-gateway-production.up.railway.app)
