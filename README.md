...
- [Carbon & Cashmere](https://api.carbon-cashmere.de/) - 104-tool MCP server: node-backed crypto intelligence (own Bitcoin Core, Rusty-Kaspa, Subtensor nodes). 100+ x402-paid REST endpoints — indicators, GARCH volatility, cointegration, BTC whales, Kaspa DAG, LLM research reports. $0.003–$2.00 USDC on Base/Solana/Algorand/Stellar. Live: https://api.carbon-cashmere.de/mcp/
