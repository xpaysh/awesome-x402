...
- [read402](https://read402.fly.dev) - Pay-per-call URL to clean Markdown extraction (Readability + Turndown). $0.02 USDC on Base mainnet via x402.org facilitator, no signup or API key. `GET /extract?url=<page-url>`. ([GitHub](https://github.com/wxtest-prog/read402))
