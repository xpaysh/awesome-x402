...
- [twzrd-x402-gate](https://www.npmjs.com/package/twzrd-x402-gate) - Buyer-side trust gate for x402 clients: free TWZRD preflight on the seller wallet before signing, via the official client's `onBeforePaymentCreation` hook or a raw-fetch wrapper. allow/warn/block + wash-flag refusal backed by real Solana x402 settlement history; zero runtime deps, MIT. ([npm](https://www.npmjs.com/package/twzrd-x402-gate)) ([GitHub](https://github.com/twzrd-sol/twzrd-trust))
