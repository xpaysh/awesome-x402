...
- [Revenue Dojo Price API](https://x402.167-172-95-184.nip.io) - Pay-per-call crypto price API for AI agents. 7 x402 endpoints: BTC/ETH prices ($0.01), per-coin quotes ($0.02), portfolio snapshots ($0.05), revenue opportunity feed ($0.03), and x402 launch audit ($1.00). USDC on Base mainnet via Coinbase facilitator. Free /demo endpoint, Bazaar discovery, OpenAPI spec, and buyer quickstart script included. ([Discovery](https://x402.167-172-95-184.nip.io/.well-known/x402) | [OpenAPI](https://x402.167-172-95-184.nip.io/openapi.json) | [Quickstart](https://x402.167-172-95-184.nip.io/x402-buyer-quickstart-public.py))
