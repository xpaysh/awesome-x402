...
- [CDK Bot](https://cdk.bot) - Agent-native commerce MCP server: AI agents buy video game keys, gift cards, and digital goods with x402 USDC payments on Base. No account or API key — quote, pay, and receive the key autonomously. MCP: https://mcp.cdk.bot/mcp
