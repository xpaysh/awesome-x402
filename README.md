...
- [InboxPolicy](https://inboxpolicy.com/x402-email-verification) - Send-decision email verification API for AI agents: `POST /v1/decide` or `POST /v1/verify`, pay $0.01 USDC on Base via x402 with no account, batch x402 up to 5,000 emails, OpenAPI at https://api.inboxpolicy.com/openapi.json, MCP server available.
