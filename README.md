...
- [wellnizz (ForeverBetter)](https://github.com/liveforeverbetter/wellnizz) - Agent-native health API with x402 micropayments. 168+ biomarkers, wearable data (WHOOP, Oura, Garmin), WGS genomics. 21 MCP tools. Pay-per-call via x402 USDC on Base + Stripe subscriptions. Self-hostable (Docker). AGPL-3.0.
