...
- [Engedi](https://engedi.digi-life17.workers.dev) - General-purpose x402 data API for AI agents. Weather, news, product prices, crypto, travel, courses, real estate — all pay-per-call via x402 USDC on Base. Free discovery at `/.well-known/x402`. No API keys, no signup.
