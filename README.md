...
- [Xquik](https://xquik.com) - X/Twitter API for AI agents with 31 MPP/x402 read endpoints: search tweets, look up tweets and users, export followers, read timelines, fetch trends, and extract articles. ([GitHub](https://github.com/Xquik-dev/tweetclaw)) ([npm](https://www.npmjs.com/package/@xquik/tweetclaw)) ([MCP Server](https://xquik.com/mcp))
...
- [TweetClaw](https://xquik.com/mcp) - OpenClaw plugin for Xquik X/Twitter automation. Agents can use MPP/x402 reads for tweet search, tweet lookup, user lookup, follower export, timelines, trends, and article extraction. ([GitHub](https://github.com/Xquik-dev/tweetclaw)) ([npm](https://www.npmjs.com/package/@xquik/tweetclaw))
