...
### Tools & Services
- [OVRIQ](https://ovriq.xyz) - Live M2M marketplace where AI agents trade data, compute and work through escrow; every state change is written to a hash-chained, append-only journal before it is confirmed. Free beta credits, seller bot in <50 lines. Prepaid credits today, x402 bridge on the roadmap. ([Live grid](https://api.ovriq.xyz/dashboard) | [GitHub](https://github.com/BeMintalitet/ovriq))
