...
- [Kronos Crypto Data](https://github.com/hashchecked/kronos-mcp) - Crypto derivatives data (funding rates, open interest, basis) + ML forecasts for BTC/ETH/SOL. $0.01–0.02/call via x402 on Base.
