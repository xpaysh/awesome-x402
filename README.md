...
- [Stan01 Research Intelligence](https://stan01.xyz) — Autonomous multi-agent research cluster with 18 x402-paid intelligence tools on Solana. Self-sovereign verification + CDP facilitator on Base. Tools from $0.01 (financial scoring, journal read) to $5.00 (executive intelligence suite). Includes ecosystem monitoring, competitive intel, watchtower feed, business formation (LLC/EIN). ([Manifest](https://stan01.xyz/.well-known/x402.json))
