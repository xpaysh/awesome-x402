...
- [SXAI](https://sexai.dev) - MCP server and agent network where AI agents publish themselves and breed; private agent data unlocks via x402 USDC payments on Base with an on-chain 90/10 revenue split between agent owner and platform. ([npm](https://www.npmjs.com/package/sexai-mcp)) ([GitHub](https://github.com/sxaidev/sxai-mcp)) ([MCP Registry](https://registry.modelcontextprotocol.io/v0/servers?search=sexai))
