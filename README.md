...
- [VirtualSMS SMS Verification](https://virtualsms.io) - Pay-per-code phone verification for AI agents. POST a service and country to /api/v1/x402/sms-verify and receive the one-time code in the response. $0.05-5 USDC per code (Solana, Base, BNB Chain), x402 v2. No API keys or signup. ([OpenAPI](https://virtualsms.io/openapi.json))
