...
- [Agent402](https://agent402.tools) - 1,100+ pay-per-call web tools for AI agents — headless browser, live web search, PDF extract/merge/split, image and audio conversion, durable wallet-keyed memory, and ~970 deterministic unit/encoding utilities. USDC on Base (also Polygon, Arbitrum), or free via proof-of-work. Hosted MCP connector + non-custodial buyer SDK. Open-source and self-hostable. ([GitHub](https://github.com/MikeyPetrillo/Agent402)) ([MCP](https://agent402.tools/mcp)) ([OpenAPI](https://agent402.tools/openapi.json)) ([Discovery](https://agent402.tools/.well-known/x402)) ([Leaderboard](https://agent402.tools/leaderboard))
