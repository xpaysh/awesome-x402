...
- [MiniFrame Tools](https://tools.miniframe.com.br) — Brazilian data & document tools for AI agents: generate Pix payment codes (BR Code / "Copia e Cola"), resolve CEP postal codes to addresses, and look up companies by CNPJ with a consolidated lead-qualification profile — plus web capture (Markdown, screenshot, PDF, structured JSON-LD/schema.org extraction) and PDF compression. 9 pay-per-call endpoints, $0.005–$0.03 USDC on Base via Coinbase CDP facilitator, x402 v2 with Bazaar discovery. No API keys, no signup. ([OpenAPI](https://tools.miniframe.com.br/openapi.json) | [llms.txt](https://tools.miniframe.com.br/llms.txt) | [MCP](https://www.npmjs.com/package/miniframe-tools-mcp) | [MCP Registry](https://registry.modelcontextprotocol.io/v0/servers?search=miniframe) | [Storefront](https://tryponcho.com/m/tools.miniframe.com.br))
