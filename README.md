...
- [Monexus Terminal](https://terminal.themonexus.com) - Live geopolitical & markets intelligence wire, SADC retail-deals corpus (30,000+ in-date product prices across Botswana, Lesotho, Mozambique, Namibia and South Africa), and a searchable 368-episode business/finance podcast corpus with funding/IPO event watchlist. Pay-per-request $0.001-$0.30 USDC on Solana mainnet via PayAI facilitator, x402 v1+v2. No API keys, no signup. Free sample endpoint + 30-day passes ($5/$19/$79). 18-tool paid MCP server listed in the official MCP Registry. ([Discovery](https://terminal.themonexus.com/.well-known/x402) | [llms.txt](https://terminal.themonexus.com/llms.txt) | [Agent Card](https://terminal.themonexus.com/agent-card.json) | [OpenAPI](https://terminal.themonexus.com/openapi.json) | [MCP Registry](https://registry.modelcontextprotocol.io/v0.1/servers?search=themonexus) | [MCP](https://terminal.themonexus.com/mcp))
