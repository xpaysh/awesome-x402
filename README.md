...
- [Suede AI](https://suedeai.ai) - Agent-payable creative IP endpoints for rights-aware music, video, musician tools, rights lookup, and audio analysis. 22 x402 resources on Base USDC; music starts at $0.20, video at $1.50, rights lookup at $0.005. Discovery via [/.well-known/x402](https://app.suedeai.ai/.well-known/x402), [/.well-known/x402.json](https://app.suedeai.ai/.well-known/x402.json), and [/.well-known/agent-card.json](https://app.suedeai.ai/.well-known/agent-card.json).
