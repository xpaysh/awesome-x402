...
- [relay402](https://relay402.georgespring.workers.dev) - Pay-per-call structured data APIs for AI agents on Base: Amazon product data ($0.01), company job openings from Greenhouse ($0.015), OFAC sanctions screening ($0.10). Schema-validated JSON, x402 v2, no API keys, no signup. ([Catalog](https://relay402.georgespring.workers.dev/index.json))
