...
- [LogicNodes](https://logicnodes.io) - Pay-per-call microservices for AI agents in USDC via x402 (no signup). Flagship **PII-Shield** returns an EIP-191-signed, on-chain-verifiable attestation per call (input_sha256→output_sha256): free 5/day, then $0.05 USDC. Chains: Base, Arbitrum, Polygon, Ethereum. Every call mints a public proof page that re-verifies the signature in-browser. MCP: `npx @logicnodez/mcp-bridge` | Python: `pip install logicnodes-m2m`. ([Try free](https://logicnodes.io/pii-shield.html)) | ([Proof example](https://logicnodes.io/p/ca70122e81cb)) | ([Verify any receipt](https://logicnodes.io/interpret)) | ([Agent Guide](https://logicnodes.io/agent-guide)) | ([llms.txt](https://logicnodes.io/llms.txt))
