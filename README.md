...
- [Sivut Stablecoin Work Radar](https://pay.sivut.co/api/public-data/stablecoin-work-radar/sample?limit=3) - Public stablecoin freelance/work radar for AI agents: free redacted sample plus an x402-paid ranked pack of public marketplace/job rows with USDC/USDT payout labels, source status, and freshness metadata. $5 USDC on Base for the full pack. ([OpenAPI](https://pay.sivut.co/openapi.json) | [llms.txt](https://pay.sivut.co/llms.txt))
