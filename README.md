...
- [PressPay](https://paygate402-two.vercel.app) - Pay-per-article publication for AI agents on Circle Arc testnet. `GET /api/article/<id>` returns HTTP 402 and settles ~$0.002–0.005 USDC per article via Circle Gateway, with a GuardRail spend-policy firewall and an AgentScore (Know-Your-Agent) trust oracle over ERC-8004/8183. Free catalogue at `/api/articles`, no signup. [Source](https://github.com/BornToTry2022/paygate402)
