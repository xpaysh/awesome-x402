...
- [MIDAX402](https://midax402.com) - Pay-per-query semantic search over 300+ curated x402 ecosystem entries: protocol mechanics, facilitators, ERC-8004, and MCP/A2A integrations. Four tiers from $0.03 to $0.15 in USDC on Base Mainnet via the CDP Facilitator, no signup or API key required. ([OpenAPI](https://midax402.com/openapi.json) | [Agent Card](https://midax402.com/.well-known/agent-card.json))
...
- - [MIDAX402](https://midax402.com) - Semantic intelligence on the x402 and agentic payments ecosystem for AI agents. 311 curated entries covering x402 protocol, ERC-8004, facilitators, MCP/A2A integrations, and business models. Pay-per-call USDC on Base Mainnet via CDP Facilitator. Four tiers: $0.03–$0.25. ERC-8004 Token #57355. No API keys, no signup. ([OpenAPI](https://midax402.com/openapi.json) | [Agent Card](https://midax402.com/.well-known/agent-card.json) | [llms.txt](https://midax402.com/llms.txt))
