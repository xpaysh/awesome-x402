...
- [China Source Intelligence](https://github.com/quietvector-agent/china-source-intelligence-api) - Open-source x402 service for Mandarin query planning, Chinese primary-source evidence bundles, and automated China research. Base USDC routes start at $0.05; a hosted custom research sprint is available through [the402](https://the402.ai/catalog/service?id=svc_0beefffd53ac422e).
