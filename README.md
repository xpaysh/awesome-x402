...
- [GPT55 x402 Gateway](https://gpt55.558686.xyz/x402/service) - x402-paid GPT-5.5 and MCP gateway for AI agents that need OpenAI-compatible chat, translation, wallet signing safety, buyer shortlist generation, MCP integration, and quote-first Base USDC payments. No account required; public machine assets include project/tool pages, service JSON, APIs.json, OpenAPI, and MCP server metadata. ([Discovery](https://gpt55.558686.xyz/.well-known/x402)) ([OpenAPI](https://gpt55.558686.xyz/openapi.json)) ([Tools](https://gpt55.558686.xyz/tools.json)) ([APIs.json](https://gpt55.558686.xyz/apis.json)) ([MCP](https://gpt55.558686.xyz/.well-known/mcp/server-card.json)) ([GitHub](https://github.com/go165/gpt55-x402-gateway))
