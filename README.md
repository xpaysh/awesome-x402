...
- [Weather Data API (kasanegi)](https://weather-data-api.kasanegi123.workers.dev/weather/current?city=Tokyo) - Global weather data for AI agents running on Cloudflare Workers edge. Current conditions and 1-7 day forecasts worldwide via Open-Meteo (CC BY 4.0). $0.001 USDC per call on Base. Narrow x402 surface — only /weather/current + /weather/forecast, with x402 v2 payment-required envelope including extensions.bazaar input/output schemas. [x402scan](https://www.x402scan.com/server/ad377650-6fef-413c-835d-738afbfd03b8) | [.well-known/x402](https://weather-data-api.kasanegi123.workers.dev/.well-known/x402) | [llms.txt](https://weather-data-api.kasanegi123.workers.dev/llms.txt) | [Source](https://github.com/MatsushitaTokitsugu/micro-data-api-factory-public)
