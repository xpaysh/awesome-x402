...
- [Space Data API](https://agentdataapi.onrender.com) - Real-time space launch data and curated historical engineering plates for AI agents. Live SpaceX/Starship/Starlink launches with countdowns ($0.01–$0.02), plus 36 visually verified public-domain plates from Ramelli's machine engravings (1588) and Agricola's De re metallica (1621) with captions, provenance, and IIIF image URLs ($0.05–$0.10). USDC on Base via CDP facilitator, x402 v2 with Bazaar discovery. No signup. ([Catalog](https://agentdataapi.onrender.com/)) ([llms.txt](https://agentdataapi.onrender.com/llms.txt)) ([OpenAPI](https://agentdataapi.onrender.com/openapi.json)) ([Manifest](https://agentdataapi.onrender.com/.well-known/x402))
