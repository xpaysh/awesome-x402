...
- [Pyrimid](https://pyrimid.ai) — Onchain distribution and monetization infrastructure for agent-to-agent commerce via x402 and ERC-8004. Aggregates agent-service catalogs, exposes MCP-native discovery, and routes USDC payments through PyrimidRouter with protocol, affiliate, and vendor splits. ([Proof](https://pyrimid.ai/proof))
