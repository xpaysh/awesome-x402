...
* [Hermes Web API](https://x402-service-two.vercel.app) — pay-per-call web search ($0.01) & page extraction ($0.02), x402 v2, USDC on Base — https://x402-service-two.vercel.app
