...
### Data & Social APIs
- [Satoshi Lightning Utility API](https://dispatches.mystere.me/docs) — Pay-per-call Bitcoin & Lightning data: mempool fees, BOLT11 invoice decoding, Lightning route queries, node stats, AI Q&A. Dual protocol: x402 (USDC on Base) + L402 (Lightning sats). \bash.001/call. ([Discovery](https://dispatches.mystere.me/.well-known/x402)) ([Dashboard](https://dispatches.mystere.me/dashboard))
