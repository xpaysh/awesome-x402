...
- [Micro Data API Factory — JP Regulatory Intelligence](https://jp-regulatory-data-api.kasanegi123.workers.dev) - Real-time Japanese government regulatory notices for compliance AI agents. 4 agencies in 1 API: FSA (Financial Services Agency) sanctions, CAA (Consumer Affairs Agency) Premiums Act violations, JFTC antimonopoly actions, MHLW pharmaceutical approvals and recalls. Plus e-Gov law amendment article-level diffs. Structured JSON with attribution fields. $0.002–$0.01 USDC per call on Base. PDL 1.0 / CC BY 4.0. NOT legal advice. [.well-known/x402](https://jp-regulatory-data-api.kasanegi123.workers.dev/.well-known/x402) | [llms.txt](https://jp-regulatory-data-api.kasanegi123.workers.dev/llms.txt) | [OpenAPI](https://jp-regulatory-data-api.kasanegi123.workers.dev/openapi.json)
