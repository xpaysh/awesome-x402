...
- [patternfetch](https://patternfetch.com) - Token-compact market-state briefs for AI trading agents: one call turns a crypto ticker + timeframe into compact candles, chart/candlestick patterns, support/resistance, regime, and interpreted indicators (RSI/EMA/ATR). Impersonal data, not advice. Pay-per-call x402 USDC on Base, free key on signup. ([MCP](https://patternfetch.com/mcp)) ([OpenAPI](https://patternfetch.com/openapi.json)) ([GitHub](https://github.com/MarvinRey7879/patternfetch-client))
- [FrameFetch](https://framefetch.net) - Agent-first video-data API across 6 platforms (YouTube, TikTok, Reddit, Instagram, Pinterest): metadata, Whisper transcript, and parametric frames (fps/timestamps to S3). Typed errors, refund-on-fail. Pay-per-call x402 USDC on Base or Stripe. ([MCP](https://framefetch.net/mcp)) ([OpenAPI](https://framefetch.net/openapi.json)) ([GitHub](https://github.com/MarvinRey7879/framefetch-client))
