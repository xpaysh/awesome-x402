...
- [GoldBean API](https://goldbean-api.xyz) — 47 Baidu AI endpoints (26 paid + 21 free): OCR, TTS, ASR, LLM Chat, Translation, NLP. Pay per call $0.01-$0.08 USDC on Base. 20 free credits. MCP server at [mcpize.com/mcp/goldbean](https://mcpize.com/mcp/goldbean). ([GitHub](https://github.com/wuzenghai616-lang/goldbean))
...
- [GoldBean 🫘](https://goldbean-api.xyz) — x402 MCP Server with 47 Baidu AI endpoints (26 paid + 21 free). OCR, TTS, ASR, LLM, Translation, NLP. $0.01-$0.08 USDC/call on Base. 20 free credits. No API keys needed. Bazaar: [/.well-known/x402-bazaar](https://goldbean-api.xyz/.well-known/x402-bazaar). ([GitHub](https://github.com/wuzenghai616-lang/goldbean))
