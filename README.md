...
### Data & Social APIs
- [JMT x402 Real-Money Agent Tools](https://jmt-x402-proxy.jmthomasofficial.workers.dev) — 25 pay-per-call API endpoints for AI agents on Base mainnet. AI-powered research ($0.03-$0.15), company intelligence with SWOT ($0.10), SEC filing analysis ($0.08), news briefings ($0.05), social sentiment ($0.05), crypto research ($0.05), competitor analysis ($0.08), regulatory monitoring ($0.06), macro dashboards ($0.04), market pulse ($0.04), domain trust scores ($0.04), web search ($0.02), crypto/stock prices ($0.03), gas snapshots ($0.002), treasury yields ($0.03), WHOIS/RDAP ($0.01), EDGAR lookup ($0.01), text utilities ($0.001-$0.002). Dexter facilitator (0% fee, gas-sponsored). ([Discovery](https://jmt-x402-proxy.jmthomasofficial.workers.dev/.well-known/x402)) ([OpenAPI](https://jmt-x402-proxy.jmthomasofficial.workers.dev/openapi.json)) ([MCP Server](https://github.com/jmthomasofficial/x402-mcp-server))
