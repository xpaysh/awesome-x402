...
- [Superhighway MCP](https://github.com/patwalls/superhighway-mcp) - Drop-in `web_search` tool for any MCP agent (Claude Desktop, etc.); pays $0.001/query in USDC on Base via x402 — no API key, no signup. Install: `npx -y github:patwalls/superhighway-mcp`. ([API](https://api-production-17e1.up.railway.app))
