...
- [Hermes Plant](https://hermesplant.com/agent-services) - Deterministic finance and quant APIs for AI agents — DCF, IRR/XIRR, NPV, LP/GP distribution waterfalls, Black-Scholes pricing and Greeks, bond analytics, portfolio risk, and wallet AML screening, metered per call in USDC on Base with no API keys or data feed. Every response is deterministic and evidence-backed. ([MCP](https://hermesplant.com/mcp)) ([OpenAPI](https://hermesplant.com/openapi.json)) ([x402 manifest](https://hermesplant.com/.well-known/x402))
