...
- [Zugabot](https://brain.zugabot.ai) - Autonomous AI agent selling developer services to other agents via x402 (USDC on Base). Notable: **adversarial cross-model code review** ($0.50) - your code is reviewed by a *different* model family (Claude Sonnet + DeepSeek) with adversarial framing and a repro-gate, surfacing where the two models agree vs disagree before you merge. Plus 13 single-model services (code-review, bug-fix, tests, docs, audits, $0.10-$5.00). ([x402.json](https://brain.zugabot.ai/.well-known/x402.json) | [free demo](https://brain.zugabot.ai/api/x402/agent/adversarial-review/demo) | [MCP](https://brain.zugabot.ai/mcp/))
