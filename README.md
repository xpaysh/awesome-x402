...
- [GLHFDD APIs](http://199.119.137.189:3300) - AI-powered text analysis, code analysis, and data transformation APIs with x402 pay-per-call on Base mainnet. 3 endpoints: /analyze/text ($0.01), /analyze/code ($0.02), /transform/data ($0.005). USDC settlement direct to wallet. No API keys, no signup. ([Discovery](http://199.119.137.189:3300/.well-known/x402) | [Health](http://199.119.137.189:3300/health))
