...
- [Suede AI](https://app.suedeai.ai) - Rights-aware music, video, audio, and on-chain IP tooling for AI agents. 24 paid skills: music generation ($0.20–$0.40 USDC), short-form video ($1.50 USDC), stems/MIDI/mastering/lyric sync, vocal isolation, on-chain Suede Registry rights lookup ($0.005 USDC), prompt analysis, and guitar rig analysis/oracle/roast. Outputs are fingerprinted for on-chain provenance attestation via the Suede Registry on Base. Multi-protocol discovery: Stripe ACP, Virtuals ACP, and x402. ([x402 manifest](https://app.suedeai.ai/.well-known/x402.json)) ([Agentic Commerce](https://app.suedeai.ai/.well-known/agentic-commerce.json)) ([Catalog](https://app.suedeai.ai/api/v1/catalog)) ([Agent Card](https://app.suedeai.ai/.well-known/agent-card.json))
...
- [Suede AI](https://app.suedeai.ai) — Creator ownership and rights-aware media workflows with public x402 discovery through the branded app domain. Endpoint pricing and payment requirements are returned by live x402 challenges rather than duplicated in this directory. ([Endpoint reference](https://github.com/Suede-AI/suede-x402-acp))
