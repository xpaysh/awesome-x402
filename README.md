...
- [GetMyCert Questions API](https://getmycert.com/developers) - 13,072 IT certification practice questions (AWS, CompTIA, Azure, GCP, Cisco, 27 certs) via x402 micropayments on Base mainnet. Pay $0.01–0.04 USDC per batch. No API key, no signup. MCP server: [Smithery](https://smithery.ai/server/getmycert-questions). Discovery: [.well-known/x402.json](https://getmycert.com/.well-known/x402.json)
