...
- [OmniNexu](https://github.com/fut66663/omninexu-v1) ⭐ **Community** — Structured US equity financial intelligence for AI agents. 8 endpoints on Base ($0.002–$0.013 USDC): company fundamentals with peer comparison, SEC filings (10-K/10-Q/8-K), insider trading (Form 4), institutional holdings (13F), CAGR growth trends, smart money bundle, and investment pulse signals. All data sourced from real SEC EDGAR, SimFin, and FRED. No API keys, no signup. Open source (Apache 2.0). ([Bazaar](https://api.cdp.coinbase.com/platform/v2/x402/discovery/search?query=omninexu)) ([GitHub](https://github.com/fut66663/omninexu-v1))
- 
