...
- [x402engine](https://x402engine.app) - Pay-per-call API gateway with 108 endpoints: 72 LLMs plus image/video generation, web search and scraping, code execution, crypto and wallet data, transaction simulation, TTS and transcription, travel, and IPFS. Pay with USDC on Base or Solana, or USDm on MegaETH. Discovery: [/.well-known/x402.json](https://x402engine.app/.well-known/x402.json) | [/.well-known/agent.json](https://x402engine.app/.well-known/agent.json). ([GitHub](https://github.com/agentc221/x402-engine)) | ([MCP](https://www.npmjs.com/package/x402engine-mcp))
