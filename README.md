...
- [AI Code Review API](https://x402-code-review.x402-cr.workers.dev) - AI-powered code review for TypeScript, JavaScript, Python, Go, Rust, and Solidity via x402 pay-per-call. $0.01–$0.05 USDC per request on Base Sepolia (testnet). No API keys, no signup. ([x402 Discovery](https://x402-code-review.x402-cr.workers.dev/.well-known/x402.json) | [Agent Card](https://x402-code-review.x402-cr.workers.dev/.well-known/agent.json) | [OpenAPI](https://x402-code-review.x402-cr.workers.dev/openapi.json))
