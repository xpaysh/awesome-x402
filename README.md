...
### Data & Social APIs
- [Scry Wallet Intelligence](https://scry.solanahub.de/x402/service.json) - Solana wallet intelligence API paid per request: wallet forensics dossiers, funding lineage, bundler/private-routing checks, pairwise wallet-connection evidence, Pump.fun launch dossiers, and live priority-fee data from an indexed 63k-wallet relationship graph. $0.001–$0.20 USDC per call on Solana and Base via CDP facilitator, x402 v2 with Bazaar discovery extension and a declared transparent health canary. No API keys, no subscriptions, evidence only. ([Products](https://scry.solanahub.de/x402/products.json)) ([Discovery](https://scry.solanahub.de/x402/discovery.json)) ([Agent guide](https://scry.solanahub.de/x402/agent-guide.json)) ([Examples](https://github.com/pfeilisolana/scry-x402-examples))
...
### Client Examples
- [scry-x402-examples](https://github.com/pfeilisolana/scry-x402-examples) - Minimal runnable client examples: decode the x402 v2 PAYMENT-REQUIRED header (Node + Python stdlib, free) and complete a real $0.001 USDC settlement via the awal CLI or x402-fetch against a live Solana wallet-intelligence API.
