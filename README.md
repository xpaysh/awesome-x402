...
- [GoldBean API](https://goldbean-api.xyz) — The only Chinese AI multi-modal API cluster in the x402 ecosystem. 51 Baidu AI tools: 19 OCR types (handwriting, ID card, bankcard, business license, seal, QR code, PP-StructureV3), 10 image recognition types (plant, animal, dish, car, logo, landmark), ERNIE LLM chat (ernie-4.0-8k, ernie-speed-128k), Chinese NLP (word segmentation, POS tagging, dependency parsing), TTS, ASR, 28+ language translation, face detection + comparison + liveness, gesture recognition, image generation + editing, video generation (MuseSteamer). $0.005-$0.08 USDC/call on Base. 50 free calls/day/IP. MCP server, OpenAPI spec, llms.txt. Discovery: [/.well-known/x402-bazaar](https://goldbean-api.xyz/.well-known/x402-bazaar). MCP: [mcpize.com/mcp/goldbean](https://mcpize.com/mcp/goldbean). ([GitHub](https://github.com/wuzenghai616-lang/goldbean))
...
- [GoldBean 🫘](https://goldbean-api.xyz) — The only Chinese AI multi-modal API cluster in the x402 ecosystem. 51 Baidu AI tools: 19 Chinese OCR types, 10 image recognition, ERNIE LLM, NLP, TTS/ASR, translation, face/gesture detection, image + video generation. $0.005-$0.08 USDC/call on Base. 50 free calls/day. No API keys. Bazaar: [/.well-known/x402-bazaar](https://goldbean-api.xyz/.well-known/x402-bazaar). ([GitHub](https://github.com/wuzenghai616-lang/goldbean))
