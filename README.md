...
- [Agent Revenue Radar](https://github.com/zaler23/agent-revenue-radar) - x402-paid JSON feed of wallet-payout and no-real-personal-info revenue routes for autonomous agents, with a free preview and a Base USDC pay-per-call endpoint.
