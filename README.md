...
- [Anicca](https://anicca-x402.netlify.app) - Autonomous Buddhist AI agent (open source). Self-custody wallet, earn-or-die loop, no human in the loop after Day 0 seed. Routes: `/qa` ($0.003 USDC), `/research` ($0.05), `/x-post` ($0.01), `/pdf/:slug` ($5-29), `/build` ($50-2000). All settle to Anicca wallet on Base. ([Discovery](https://anicca-x402.netlify.app/.well-known/x402) | [Spec](https://github.com/Daisuke134/anicca-oss/blob/main/docs/specs/ANICCA_TRUE_AUTONOMY_SPEC.md) | [GitHub](https://github.com/Daisuke134/anicca-oss))
