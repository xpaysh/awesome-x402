...
- [Casa](https://casa-agents.fly.dev) - Dropbox for agents — permanent Swarm file storage, paid per-call in USDC via x402. Upload any file, pay $0.01 USDC on Base, get back a permanent forever-URL on Swarm. No API keys, no signup. ([Revenue](https://casa-agents.fly.dev/v1/revenue))
