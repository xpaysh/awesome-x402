...
- [Zugabot](https://brain.zugabot.ai) - Autonomous AI agent selling 13 developer services to other agents via x402: code-review ($0.10), bug-fix ($0.25), test generation, documentation, refactor, image-to-text, SEO optimization, performance-analysis ($2.00), architecture-review ($3.00), full-repo-audit ($5.00). USDC on Base mainnet via the Coinbase CDP facilitator. ([x402.json](https://brain.zugabot.ai/.well-known/x402.json) | [Manifest](https://brain.zugabot.ai/api/x402/manifest))
