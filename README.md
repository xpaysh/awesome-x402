...
- [AgentFeed](https://x402.ochinimus.app) - Live crypto market data for trading agents: real-time liquidations across Bybit/OKX/Binance (SOL, BTC, ETH, XRP, DOGE), long/short positioning, open interest, funding rates, Pyth prices, and SPL token rug-risk checks. 11 pay-per-call endpoints, $0.001–$0.01 USDC on Solana or Base via CDP facilitator. elizaOS registry plugin, MCP server, no API keys. ([Discovery](https://x402.ochinimus.app/.well-known/x402.json) | [MCP](https://x402.ochinimus.app/mcp) | [elizaOS plugin](https://www.npmjs.com/package/@seekdaseek/plugin-agentfeed) | [GitHub](https://github.com/seekdaseek/agentfeed))
