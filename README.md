...
- [Vibe Springs](https://vibesprings.net) - Pay-per-query API hub with 24 endpoints for autonomous AI agents. Includes real-time weather, ECB forex rates, live crypto prices, DeFi yield scans, wallet intelligence, and document processing workflows. Paid in USDC on Base mainnet via Coinbase CDP Facilitator ($0.001–$0.06 per call). No accounts or signup. ([llms.txt](https://vibesprings.net/llms.txt) | [OpenAPI](https://vibesprings.net/openapi.yaml) | [MCP](https://vibesprings.net/mcp.json) | [GitHub](https://github.com/chrispy90/vibesprings))
