...
- [Fanfare] (https://fanfare.run) - x402 native real-time sports intelligence for the full fan experience. Schedules, scores, venues, weather, stats, tickets, neighborhood discovery, and composite travel bundles allowing end users to plan the ultimate fan experience. Current leagues include MLB, NBA, WNBA, NHL, NFL, FIFA (World Cup), and other major sports. Endpoints cost $0.001-$0.25 USDC on base mainnet. Indexed on agentic.market.
