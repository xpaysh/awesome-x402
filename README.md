...
- [IBANforge](https://ibanforge.com) - IBAN validation & BIC/SWIFT lookup API with x402 USDC micropayments and MCP integration for AI agents. Pay-per-request pricing on Base L2.
